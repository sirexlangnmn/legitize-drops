                ...
                <div class="card">
                    <div class="card-body p-b-0">
                        ...
                        <ul class="nav nav-tabs customtab" role="tablist">
                            ...
                            <li class="nav-item"> 
                                <a class="nav-link active" href="spreadsheet_facebook.php" role="tab">
                                        ...
                                        <div class="table-responsive m-t-40">
                                            <table id="example23" class="table table-bordered table-striped display nowrap table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <a href="#" class="label label-success" data-toggle="modal" data-target="#modal_stakes_insert_facebook"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Update Stakes"></i>
                                                            </a>
                                                        </td>
